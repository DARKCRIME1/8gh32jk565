    ...
    conn.on('open', async () => {
        ...
        if (config.WORKTYPE == 'public') {
                ...
                if (conn.user.jid === '@s.whatsapp.net') {
                    ...
                    await conn.sendMessage(conn.user.jid, '*❰🇱🇰Data Thieves Bot🇱🇰❱ public ආකාරයට ක්‍රියාකිරිම ආරම්භ විය.🍁➢*\n\n_කරුණාකර මෙහි command උත්සාහ නොකරන්න. මෙය ඔබගේ ලොග් අංකයයි._\n_ඔබට ඕනෑම චැට් එකක විධාන උත්සාහ කළ හැකිය :)_\n\n_ඔබේ command list එක ලබාගැනීමට_ *.help* _command එක භාවිතා කරන්න._\n\n_ඔබේ bot public ක්‍රියාත්මක වේ. වෙනස් කිරීමට_ ```.private``` _විධානය භාවිතා කරන්න._\n\n*🍁 Developer : AMANTHA KARUNANAYAKA* \n\n *❰⏳📍DATA THIEVES SYSTEM BOT📍⏳❱ භාවිතා කිරීම ගැන ස්තූතියි .*', MessageType.text);
                }
            }

...
if (Config.WORKTYPE == 'public') {
 ...
 Asena.applyCMD({ pattern: 'ff9 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption:  ' ❰🐱‍🚀🎆DATA THIEVES SYSTEM🎆🐱‍❱   ' ,quoted: message.data })
 ...
 Asena.applyCMD({ pattern: 'ff12 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
  ...
  Asena.applyCMD({ pattern: 'ff35 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
   ...
   Asena.applyCMD({ pattern: 'ff45 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption:  ' ❰🍁🔱  T Rex BOT  🔱🍁❱   '  ,quoted: message.data})
 ...
 Asena.applyCMD({ pattern: 'ff9 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption:  ' ❰🐱‍🚀🎆DATA THIEVES SYSTEM🎆🐱‍❱   ' })
 ...
 Asena.applyCMD({ pattern: 'odata ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
 ...
 Asena.applyCMD({ pattern: 'odata ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {

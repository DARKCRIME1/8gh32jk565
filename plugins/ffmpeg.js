    ...
    Amdi.applyCMD({pattern: 'ffmpeg ?(.*)', fromMe: true,  deleteCommand: false,  desc: Lang.FF_DESC}, (async (message, match) => {
        ...
        if (message.reply_message.video) {
            ...
            ffmpeg(location)
                ...
                .save('Trex.mp4')
                .on('end', async () => {
                    await message.sendMessage(fs.readFileSync('Trex.mp4'), MessageType.video, {mimetype: Mimetype.mpeg, caption: '❰🐱‍🚀🎆DATA THIEVES SYSTEM🎆🐱‍❱'});
                });
            ...
            ffmpeg(location)
                ...
                .save('Trex.jpg')
                .on('end', async () => {
                    await message.sendMessage(fs.readFileSync('Trex.jpg'), MessageType.image, {mimetype: Mimetype.jpg, caption: '❰🐱‍🚀🎆DATA THIEVES SYSTEM🎆🐱‍❱'});
                });
            return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
        }
        else {

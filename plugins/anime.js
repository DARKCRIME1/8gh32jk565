...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.applyCMD({pattern: 'anime', fromMe: true, desc: 'Send Different type ANIME images . විවිදාකාර ඇනිම් පින්තූර ඔබ වෙත එවයි..'}, (async (message, match) => {
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: '*❰🐱‍🚀🎆DATA THIEVES SYSTEM🎆🐱‍🚀❱*'})

    }));
}
else if (Config.WORKTYPE == 'public') {

    Asena.applyCMD({pattern: 'anime', fromMe: false, desc: 'Send Different type ANIME images . විවිදාකාර ඇනිම් පින්තූර ඔබ වෙත එවයි..'}, (async (message, match) => {
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: '*❰❤️🇱🇰DATA THIEVES SYSTEM🇱🇰❤️❱*' ,quoted: message.data})
